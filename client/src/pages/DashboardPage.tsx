...
const stats = [
    { name: 'Questions Attempted', value: '405', change: '+4.75%', changeType: 'positive' },
    { name: 'Number of Matches', value: '12', change: '+54.02%', changeType: 'negative' },
    { name: 'Acceptance Rate', value: '74.5%', change: '-1.39%', changeType: 'positive' },
]
const statuses = {
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                        <div className="flex items-center justify-between">
                            <h2 className="text-base font-semibold leading-7 text-gray-900">Recent Matches</h2>
                            <Link to={'/matches'} className="text-sm font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                                View all<span className="sr-only">, matches</span>
                            </Link>
                        </div>
